package com.example.soallatihandataintent_hendrianihsanmutakin;
...
public class HasilPesanGofood extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(HasilPesanGofood.this, MainActivity.class);
                startActivity(i);
            }
        });
    }
