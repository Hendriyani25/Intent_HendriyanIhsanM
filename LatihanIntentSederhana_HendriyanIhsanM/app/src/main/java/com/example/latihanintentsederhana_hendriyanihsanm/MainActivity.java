package com.example.latihanintentsederhana_hendriyanihsanm;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.implicitintent:
                Intent implicit = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.instagram.com/p/CVEoR2wpyjD/?utm_source=ig_web_copy_link"));
